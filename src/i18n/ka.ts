...
export const ka: Strings = {
  ...
  wallet: {
    ...
    oneTap: 'ორი შეხებით იყიდება',
    confirmBuy: (price: string) => `დაადასტურე ${price}`,
  ...
  profile: {
    ...
    resetConfirm: 'კიდევ დააჭირე წასაშლელად',
    resetNote: 'ტოკენები, რაუნდები, სერია და ჯილდოები. უკან დაბრუნება არ იქნება.',
  },
};
